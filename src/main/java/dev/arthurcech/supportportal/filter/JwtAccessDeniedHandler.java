...
import static dev.arthurcech.supportportal.constant.SecurityConstant.ACCESS_DENIED_MESSAGE;
...
/**
 * Este filtro é invocado quando o usuário tenta acessar uma recurso que ele não
 * tem permissão
 */
@Component
